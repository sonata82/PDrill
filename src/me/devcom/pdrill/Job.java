...
public class Job {
    ...
    public Job(IDrill drill, String dir, Integer len) {
        this.direction = dir;
        this.length = len;
        this.drill = drill;
     ...
     * this.direction = dir; this.length = len; this.linkManager = linkManager;
     * 
     * valid = true; }
     */
    ...
    private void moveBlock(IDrill drill, String direction) {
        ...
        if (direction.matches("f|b|r|l|u|d")) {
            ...
            if (fuel != null) {
                ...
                drill.sendMessage("No fuel in drill [" + drill.getId() + "]!");
